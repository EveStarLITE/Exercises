...
a new bunny is created each turn for each female over two in a male over 2 exists. 
New bunnies born should be the same color as their mother.
older than 10 years old, it dies.
If a radioactive mutant vampire bunny is born then each turn it will change exactly one non radioactive bunny into a radioactive vampire bunny per each alive
